...
// +a z1 = w1 + 4                  = w14 + 5    w1 = w14 + 1   9, 8    2,1
// +b z2 = w2 + 11 + z1 * 26       = w13 + 4    w2 = w13 - 7   2, 9    1, 8
// +c z3 = w3 + 5 + z2 * 26        = w12 + 10   w3 = w12 + 5   9, 4    6,1
// +d z4 = w4 + 11 + z3 * 26        = w9 + 3     w4 = w9 - 8   1, 9    1, 9
// +e z5 = w5 + 14 + z4 * 26        = w6 + 10    w5 = w6 - 4    5, 9   1, 5
// -e z6 = z7 * 26 + w6 + 10
// +f z7 = w7 + 11 + z6 * 26        = w8 + 9     w7 = w8 - 2    7, 9   1, 3
// -f z8 = z9 * 26 + w8 + 9
// -d z9 = z10 * 26 + w9 + 3
// +g z10 = w10 + 5 + z9 * 26       = w11 + 5    w10 = w11      9, 9   1,1
